...
if __name__ == '__main__':
    ...
    bfront_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 0 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bfront)
    bright = Button(text="R", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('R'))
    bright_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 1 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bright)
    bup = Button(text="U", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('U'))
    bup_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 2 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bup)
    bback = Button(text="B", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('B'))
    bback_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 3 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bback)
    bleft = Button(text="L", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('L'))
    bleft_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 4 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bleft)
    bdown = Button(text="D", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('D'))
    bdown_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 5 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bdown)

    bffront = Button(text="f", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('f'))
    bffront_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 6 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bffront)
    brright = Button(text="r", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('r'))
    brright_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 7 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=brright)
    buup = Button(text="u", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('u'))
    buup_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 8 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=buup)
    bbback = Button(text="b", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('b'))
    bbback_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 9 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bbback)
    blleft = Button(text="l", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('l'))
    bbleft_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 10 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=blleft)
    bddown = Button(text="d", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('d'))
    bddown_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 11 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bddown)

    bm = Button(text="M", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('M'))
    bm_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 12 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bm)
    be = Button(text="E", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('E'))
    be_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 13 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=be)
    bs = Button(text="S", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('S'))
    bs_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 14 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bs)
    bx = Button(text="x", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('x'))
    bx_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 15 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bx)
    by = Button(text="y", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('y'))
    by_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 16 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=by)
    bz = Button(text="z", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('z'))
    bz_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 17 * g_button_width, 10 + 0 * g_button_width, anchor=NW, window=bz)


    bfrontcc = Button(text="F'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('F"'))
    bfrontcc_window = v_canvas.create_window(20 + 12* g_faces_cube_width + 0 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bfrontcc)
    brightcc = Button(text="R'", height=2, width=4, font=('',9),  relief=RAISED, command=lambda:draw_move('R"'))
    brightcc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 1 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=brightcc)
    bupcc = Button(text="U'", height=2, width=4,  font=('',9), relief=RAISED, command=lambda:draw_move('U"'))
    bupcc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 2 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bupcc)
    bbackcc = Button(text="B'", height=2, width=4,  font=('',9), relief=RAISED, command=lambda:draw_move('B"'))
    bbackcc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 3 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bbackcc)
    bleftcc = Button(text="L'", height=2, width=4,  font=('',9), relief=RAISED, command=lambda:draw_move('L"'))
    bleftcc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 4 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bleftcc)
    bdowncc = Button(text="D'", height=2, width=4,  font=('',9), relief=RAISED, command=lambda:draw_move('D"'))
    bdowncc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 5 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bdowncc)

    bffront2 = Button(text="f'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('f"'))
    bffront2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 6 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bffront2)
    brright2 = Button(text="r'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('r"'))
    brright2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 7 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=brright2)
    buup2 = Button(text="u'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('u"'))
    buup2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 8 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=buup2)
    bbback2 = Button(text="b'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('b"'))
    bbback2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 9 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bbback2)
    blleft2 = Button(text="l'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('l"'))
    bbleft2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 10 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=blleft2)
    bddown2 = Button(text="d'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('d"'))
    bddown2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 11 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bddown2)

    bmcc = Button(text="M'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('M"'))
    bmcc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 12 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bmcc)
    becc = Button(text="E'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('E"'))
    becc_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 13 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=becc)
    bscc = Button(text="S'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('S"'))
    bscc_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 14 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bscc)
    bxcc = Button(text="x'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('x"'))
    bxcc_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 15 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bxcc)
    bycc = Button(text="y'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('y"'))
    bycc_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 16 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bycc)
    bzcc = Button(text="z'", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('z"'))
    bzcc_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 17 * g_button_width, 10 + 1.05 * g_button_width, anchor=NW, window=bzcc)


    bfront2 = Button(text="F2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('F2'))
    bfront2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 0 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bfront2)
    bright2 = Button(text="R2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('R2'))
    bright2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 1 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bright2)
    bup2 = Button(text="U2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('U2'))
    bup2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 2 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bup2)
    bback2 = Button(text="B2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('B2'))
    bback2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 3 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bback2)
    bleft2 = Button(text="L2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('L2'))
    bleft2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 4 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bleft2)
    bdown2 = Button(text="D2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('D2'))
    bdown2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 5 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bdown2)

    bffront2 = Button(text="f2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('f2'))
    bffront2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 6 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bffront2)
    brright2 = Button(text="r2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('r2'))
    brright2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 7 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=brright2)
    buup2 = Button(text="u2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('u2'))
    buup2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 8 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=buup2)
    bbback2 = Button(text="b2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('b2'))
    bbback2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 9 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bbback2)
    blleft2 = Button(text="l2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('l2'))
    bbleft2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 10 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=blleft2)
    bddown2 = Button(text="d2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('d2 '))
    bddown2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 11 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bddown2)

    bm2 = Button(text="M2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('M2'))
    bm2_window = v_canvas.create_window(20 + 12 * g_faces_cube_width + 12 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bm2)
    be2 = Button(text="E2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('E2'))
    be2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 13 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=be2)
    bs2 = Button(text="S2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('S2'))
    bs2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 14 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bs2)
    bx2 = Button(text="x2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('x2'))
    bx2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 15 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=bx2)
    by2 = Button(text="y2", height=2, width=4, font=('',9), relief=RAISED, command=lambda:draw_move('y2'))
    by2_window = v_canvas.create_window(20 + 12  * g_faces_cube_width + 16 * g_button_width, 10 + 2.1 * g_button_width, anchor=NW, window=by2)
